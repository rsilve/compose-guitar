...
export const action_transpose_change = (transpose: number): Promise<void> => publish_action(new Action(TRANSPOSE_CHANGE, { transpose }));
...
export const action_track_edit = (track_payload: IPayloadEditor): Promise<void> => publish_action(new Action(TRACK_EDIT, track_payload));
...
export const action_track_edit_apply = (track_payload: IPayloadEditor): Promise<void> => publish_action(new Action(TRACK_EDIT_APPLY, track_payload));

export const TRACK_COPY = 'TRACK_COPY';
export const action_track_copy = (track_payload: IPayloadEditor): Promise<void> => publish_action(new Action(TRACK_COPY, track_payload));
...
export const action_synchronization_activation_request = (): Promise<void> => publish_action(new Action(SYNCHRO_ACTIVATION_REQUEST));

export const SYNCHRO_DEACTIVATION_REQUEST = 'SYNCHRO_DEACTIVATION_REQUEST';
export const action_synchronization_deactivation_request = (): Promise<void> => publish_action(new Action(SYNCHRO_DEACTIVATION_REQUEST));
