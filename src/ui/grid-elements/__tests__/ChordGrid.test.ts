...
describe("chords-grid element", () => {
  ...
  it("have text_grid property", async () => {
  ...
  it("have transpose property", async () => {
  ...
  it("have text_grid 2 property", async () => {
  ...
  it("have text_grid 3 property", async () => {
  ...
  it("have text_grid 4 property", async () => {
  ...
  it("have text_grid 5 property", async () => {
  ...
  it("have text_grid 6 property", async () => {
  ...
  it("have text_grid 7 property", async () => {
  ...
  it("have text_grid 8 property", async () => {
