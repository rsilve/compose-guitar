    ...
    return html`
      <table class="grid-measure-8">
        <tbody>
          ...
          <tr>
            <td class="grid-measure-beat-3">${chordRender(measure.chords[2].transpose(transpose))}</td>
            <td class="grid-measure-beat-4">${chordRender(measure.chords[3].transpose(transpose))}</td>
          </tr>
        </tbody>
      </table>
    `;
